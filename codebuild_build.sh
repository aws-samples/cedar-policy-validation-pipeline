...
# https://github.com/aws/aws-codebuild-docker-images/blob/master/local_builds/LICENSE.txt

# modified version of https://github.com/aws/aws-codebuild-docker-images/blob/master/local_builds/codebuild_build.sh
# that sets explicit defaults for:
# - image_name="public.ecr.aws/codebuild/amazonlinux2-x86_64-standard:5.0" (to match template.yml)
# - artifact_dir=".codebuild" (required but not used)
# - report_dir=".codebuild" (for .zip version of junitreport.xml)
...
image_flag=true
image_name="public.ecr.aws/codebuild/amazonlinux2-x86_64-standard:5.0"
artifact_flag=true
artifact_dir=".codebuild"
report_dir=".codebuild"
